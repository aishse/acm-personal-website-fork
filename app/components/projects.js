  ...
  return (
    <div id="projects" className='scroll-mt-20'>
      ...
      <div className="grid grid-cols-2 gap-12">
        ...
        <div className="rounded-xl bg-purple-600 justify-items-center text-center py-5">
          ...
          <a href="#" className="font-bold text-xl hover:text-black transition-colors duration-350 ">Learn More</a>
        </div>
